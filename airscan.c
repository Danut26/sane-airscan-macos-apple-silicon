...
#ifdef __APPLE__
SANE_Status sane_airscan_init(SANE_Int *v, SANE_Auth_Callback a) { return sane_init(v,a); }
void sane_airscan_exit(void) { sane_exit(); }
SANE_Status sane_airscan_get_devices(const SANE_Device ***d, SANE_Bool l) { return sane_get_devices(d,l); }
SANE_Status sane_airscan_open(SANE_String_Const n, SANE_Handle *h) { return sane_open(n,h); }
void sane_airscan_close(SANE_Handle h) { sane_close(h); }
const SANE_Option_Descriptor *sane_airscan_get_option_descriptor(SANE_Handle h, SANE_Int o) { return sane_get_option_descriptor(h,o); }
SANE_Status sane_airscan_control_option(SANE_Handle h, SANE_Int o, SANE_Action a, void *v, SANE_Int *i) { return sane_control_option(h,o,a,v,i); }
SANE_Status sane_airscan_get_parameters(SANE_Handle h, SANE_Parameters *p) { return sane_get_parameters(h,p); }
SANE_Status sane_airscan_start(SANE_Handle h) { return sane_start(h); }
SANE_Status sane_airscan_read(SANE_Handle h, SANE_Byte *d, SANE_Int m, SANE_Int *l) { return sane_read(h,d,m,l); }
void sane_airscan_cancel(SANE_Handle h) { sane_cancel(h); }
SANE_Status sane_airscan_set_io_mode(SANE_Handle h, SANE_Bool n) { return sane_set_io_mode(h,n); }
SANE_Status sane_airscan_get_select_fd(SANE_Handle h, SANE_Int *fd) { return sane_get_select_fd(h,fd); }
#endif
